...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 pt-20 md:pt-28">
        {/* Main Title with Atmospheric Glow */}
        <motion.div 
          className="mb-8 atmospheric-glow"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        >
          <h1 className="font-mono mb-4 glow-text text-4xl md:text-5xl lg:text-6xl text-white">
            MUHAMMAD RAFI
          </h1>
          <h2 className="font-mono mb-4 text-xl md:text-2xl text-white/80">
            SOFTWARE ENGINEER | AI ENTHUSIAST
          </h2>
          <div className="inline-block">
            <p className="font-mono text-lg" style={{ color: '#8A2BE2' }}>
              {displayText}
        ...
        <motion.div 
          className="mb-12 neo-card p-8 max-w-2xl mx-auto float-animation"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.2 }}
        >
          <div className="mb-4">
            <span className="font-mono text-sm opacity-60" style={{ color: '#8A2BE2' }}>
              // Integrated Development Environment
            </span>
          </div>
          <pre className="font-mono text-left text-sm md:text-base" style={{ color: '#8A2BE2' }}>
...
> echo "Ready to innovate"`}
        ...
        >
          <button 
            ...
            className="neo-button px-8 py-4 font-mono text-lg"
            style={{ color: '#8A2BE2' }}
          >
            View Projects
          </button>
        ...
        >
          {[
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 rounded-lg flex items-center justify-center neo-button transition-all duration-300"
              style={{ color: '#8A2BE2' }}
